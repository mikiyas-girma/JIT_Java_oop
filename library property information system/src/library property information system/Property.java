    ...
    public class Property {
        ...
        public void removeBook(String id) {
            ...
            try {
                ...
                // removing the book with specified ( given ) id
                books.remove(id);
        ...
        public void removeComputer(String id) {
            ...
            try {
                ...
                String line;
                while((line=br.readLine()) !=null) {
                    String[] computerdetails=line.split(",");
                    if (!computerdetails[0].equals(id)) {
                        computers.add(new Computer(computerdetails[0],computerdetails[1],computerdetails[2]));
                    }
                }
                br.close();
                FileWriter writer=new FileWriter("computers.txt");
                for(Computer computer : computers) {
                    writer.write(computer.getid() + "," + computer.getModel() + "," + computer.getOperatingSystem() + "\n");
                }
                writer.close();
            }catch (IOException e) {
                e.printStackTrace();
